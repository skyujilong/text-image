...
def test_build_srt_single_entry():
    ...
    entries = [{"storyboard_id": 0, "text": "你好世界", "start_time": 0.0, "end_time": 1.5}]
...
def test_build_srt_multiple_entries():
    pipe = AudioPipeline(silence_ms=200, lufs=-16)
    entries = [
        {"storyboard_id": 0, "text": "第一句", "start_time": 0.0, "end_time": 1.0},
        {"storyboard_id": 1, "text": "第二句", "start_time": 1.2, "end_time": 2.5},
    ]
    srt = pipe.build_srt(entries)
    assert "第一句" in srt
    assert "第二句" in srt
